...
namespace Travel_MER.Controllers
{
    public class AutorController : Controller
    {
        ...
        public AutorController(MerTravelContext context)
        {
            _context = context;
        }
        ...
        {
            var autors = from autor in _context.Autors select autor;
            ...
            return _context.Autors != null ? 
                          ...
                          Problem("Entity set 'MerTravelContext.Autors'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MerTravelContext.Autors'  is null.");
            }
            var autor = await _context.Autors.FindAsync(id);
            if (autor != null)
            {
